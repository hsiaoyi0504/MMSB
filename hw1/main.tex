...
\subsection{Problem Set 2.4.8 Rapid equilibrium approximation.}
	...
	\begin{enumerate}[a)]
		...
		\end{align*}
		The simulation result are shown below (original model).\\
		\includegraphics[scale=0.25]{{2.4.8.transient}.jpg}
		\includegraphics[scale=0.25]{{2.4.8.steady}.jpg}
...
\subsection{Problem Set 2.4.9 Quasi-steady-state approximation.}
	...
	\begin{enumerate}[a)]
		...
		\end{align*}
		The simulation result are shown in next page (original model).\\
		\includegraphics[scale=0.25]{{2.4.9.transient}.jpg}
		\includegraphics[scale=0.25]{{2.4.9.steady}.jpg}
